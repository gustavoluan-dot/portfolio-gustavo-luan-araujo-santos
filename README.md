...
| :--- | :--- | :--- |
| Lab. de Classificação Visual (Boné) | Experimento de detecção de acessórios e análise técnica de viés algorítmico (falsos positivos). | [Ver Repositório](https://github.com/gustavoluan-dot/laboratorio-deteccao-com-bone-ou-sem) |
